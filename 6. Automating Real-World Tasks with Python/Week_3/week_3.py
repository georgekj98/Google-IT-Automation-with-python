...
def process_data(data):
  ...
  for item in data:
    ...
    pop_year[item["car"]["car_year"]] = pop_year.get(item["car"]["car_year"],0) + item["total_sales"]
    pop_year = sorted(pop_year.items(), key = lambda x: x[1], reverse=True)

  summary = [
    "The {} generated the most revenue: ${}".format(
      format_car(max_revenue["car"]), max_revenue["revenue"]),
    "The {} had the most sales: {}".format(max_sales["car_model"],max_sales["total_sales"]),
    "The most popular year was {} with {} sales.".format(pop_year[0][0], pop_year[0][1])
  ]
...
def main(argv):
  ...
  message = emails.generate("automation@example.com", "student-04-1c6fcfeab467@example.com", "Sales summary for last month", "\n".join(summary), "/tmp/cars.pdf")
  emails.send(message)
